...
namespace Hange.Utility
{
    ...
    public class Utils
    {
        ...
        /// <param name="code">编码</param>
        /// <returns></returns>
        public static IEnumerable<string> GetTxtValue(string path, Encoding code)
        {
        ...
        /// <param name="path">路径</param>
        /// <returns></returns>
        public static IEnumerable<string> GetTxtValue(string path)
        {
            return GetTxtValue(path, Encoding.Default);
        }
